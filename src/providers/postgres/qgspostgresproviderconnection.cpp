  ...
  return QgsAbstractDatabaseProviderConnection::sqlDictionary().unite(
  {
    ...
    },
    {
      Qgis::SqlKeywordCategory::Geospatial,
      {
        ...
        QStringLiteral( "PostGIS_Full_Version" ),
        QStringLiteral( "PostGIS_GEOS_Compiled_Version" ),
        QStringLiteral( "PostGIS_HasBBox" ),
        QStringLiteral( "PostGIS_LibXML_Version" ),
        QStringLiteral( "PostGIS_PROJ_Version" ),
        QStringLiteral( "RemoveUnusedPrimitives" ),
        QStringLiteral( "ST_3DArea" ),
        QStringLiteral( "ST_3DClosestPoint" ),
        QStringLiteral( "ST_3DConvexHull" ),
        ...
        QStringLiteral( "ST_AsFlatGeobuf" ),
        ...
        QStringLiteral( "ST_ClusterIntersectingWin" ),
        QStringLiteral( "ST_ClusterKMeans" ),
        QStringLiteral( "ST_ClusterWithin" ),
        QStringLiteral( "ST_ClusterWithinWin" ),
        ...
        QStringLiteral( "ST_Contour" ),
        QStringLiteral( "ST_ConvexHull" ),
        QStringLiteral( "ST_CoordDim" ),
        QStringLiteral( "ST_Count" ),
        QStringLiteral( "ST_CountAgg" ),
        QStringLiteral( "ST_CoverageInvalidEdges" ),
        QStringLiteral( "ST_CoverageSimplify" ),
        QStringLiteral( "ST_CoverageUnion" ),
        ...
        QStringLiteral( "ST_DumpSegments" ),
        ...
        QStringLiteral( "ST_FromFlatGeobuf" ),
        QStringLiteral( "ST_FromFlatGeobufToTable" ),
        ...
        QStringLiteral( "ST_GeomFromMARC21" ),
        ...
        QStringLiteral( "ST_InterpolateRaster" ),
        QStringLiteral( "ST_Intersection" ),
        QStringLiteral( "ST_Intersects" ),
        QStringLiteral( "ST_InverseTransformPipeline" ),
        ...
        QStringLiteral( "ST_MinimumBoundingRadius" ),
        ...
        QStringLiteral( "ST_OptimalAlphaShape" ),
        ...
        QStringLiteral( "ST_PointM" ),
        QStringLiteral( "ST_PointN" ),
        QStringLiteral( "ST_PointOnSurface" ),
        QStringLiteral( "ST_PointZ" ),
        QStringLiteral( "ST_PointZM" ),
        ...
        QStringLiteral( "ST_TransformPipeline" ),
        QStringLiteral( "ST_Translate" ),
        QStringLiteral( "ST_TriangulatePolygon" ),
        ...
        QStringLiteral( "postgis.gdal_config_options" ),
        QStringLiteral( "postgis.gdal_datapath" ),
        QStringLiteral( "postgis.gdal_enabled_drivers" ),
        QStringLiteral( "postgis_sfcgal_full_version" ),
        QStringLiteral( "postgis_sfcgal_version" ),
        QStringLiteral( "postgis_srs" ),
        QStringLiteral( "postgis_srs_all" ),
        QStringLiteral( "postgis_srs_codes" ),
        QStringLiteral( "postgis_srs_search" ),
        QStringLiteral( "|=|" ),
        QStringLiteral( "~" ),
        QStringLiteral( "~(box2df,box2df)" ),
        QStringLiteral( "~(box2df,geometry)" ),
